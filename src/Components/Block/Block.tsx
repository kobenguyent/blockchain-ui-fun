...
export const Block = ({block, setSelectedBlockIndex}: any) => {
                                    ...
                                    <ListGroup className="list-group-flush">
                                        <ListGroup.Item>Hash
                                            <div className="text-truncate"
                                                 style={{"color": '#' + item.hash.substring(0, 6)}}>{item.hash}</div>
                                        </ListGroup.Item>
                                        <ListGroup.Item>Previous hash
                                            <div className="text-truncate"
                                                 style={{"color": '#' + item.prevHash.substring(0, 6)}}>{item.prevHash}</div>
                                        </ListGroup.Item>
